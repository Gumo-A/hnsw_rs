...
use points::{
    ...
    points::block_points::{
        block::{
            ...
            BlockID, PointsBlock, MAX_PER_BLOCK,
        },
...
impl HNSWDisk {
    ...
    pub fn get_point(&mut self, idx: NodeID) -> Option<&Point> {
...
struct PointsDisk {
    file_handle: File,
    buffer: HashMap<BlockID, PointsBlock>,
    header: PointsHeader,
}
...
impl PointsDisk {
    ...
    fn get_point(&mut self, idx: NodeID) -> Option<&Point> {
